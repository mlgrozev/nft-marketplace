            ...
            nfts && nfts.map((nft, i) => (
              <div key={i} className="border shadow rounded-xl overflow-hidden">
                ...
                <div className="p-4 bg-black">
                  ...
                  <button className="w-full bg-green-500 text-white font-bold py-2 px-12 rounded hover:bg-green-700" onClick={() => buyNft(nft)}>{nft.isAuction&& nft.isAuction ? "Bid" : "Buy"}</button>
                </div>
              </div>
            ))
          }
